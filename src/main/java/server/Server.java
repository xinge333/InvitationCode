...
import dao.InviCodeDao;
import dao.SchoolDao;
import model.InviCode;
import model.School;
        ...
        try {
            ...
            try {
                while (true){
                    ...
                    if(replaceBlank(shoolName).length() <= 0){
                        dataOutputStream.writeUTF("学校名称不能为空，请重新输入：");
